...
const AppConfigOnChain: Record<number, AppConfigType> = {
    [CHAINS_ID.zkfair]: {
        ...
        graph: {
            ...
            baseBlock: 'https://gql.hyperionx.xyz/subgraphs/name/hyperionx/zkfair-blocks',
          },
    ...
    [CHAINS_ID.arbitrum]: {
        ...
        graph: {
          ...
          perpetual: 'https://gql.substancex.io/subgraphs/name/substanceexchangedevelop/coreprod',
          baseBlock: 'https://api.thegraph.com/subgraphs/name/ianlapham/arbitrum-one-blocks',
        },

...
const baseTokens: Record<string, Token[]> = {
  ...
  [CHAINS_ID.arbitrumSepolia]: [
    {
      ...
      // coinType: 1,
      displayDecimal: 2,
      address: addressMap[CHAINS_ID.arbitrumSepolia].USDAddress,
      tag: [],
      exchangeStable: true,
      withdraw: true,
      deposit: true,
    ...
    },
    {
      ...
      disabled: false,
      displayDecimal: 2,
      address: addressMap[CHAINS_ID.arbitrumSepolia].SEXAddress,
      tag: [],
      deposit: true,
      withdraw: true,
      "futureLongId": 10000000_2, // 这里设置一个很大的数，避免被重复使用
    ...
    },
    {
      ...
      disabled: false,
      displayDecimal: 2,
      address: addressMap[CHAINS_ID.arbitrumSepolia].SLPAddress,
      tag: [],
      deposit: true,
      withdraw: true,
      "futureLongId": 10000000_3, // 这里设置一个很大的数，避免被重复使用
    ...
    },
    {
      ...
      disabled: false,
      displayDecimal: 2,
      address: addressMap[CHAINS_ID.arbitrumSepolia].USDCAddress,
      tag: [],
      deposit: true,
      stable: true,
      "futureLongId": 10000000_4, // 这里设置一个很大的数，避免被重复使用
    ...
    },
    {
      ...
      displayDecimal: 2,
      tag: [],
      address: addressMap[CHAINS_ID.arbitrumSepolia].xHPX,
      "futureLongId": 10000000_6, // 这里设置一个很大的数，避免被重复使用
      "futureShortId": 10000000_6,
      "pars": 0,
      "maxProfitRatio": 1,
  ...
  [CHAINS_ID.iotxTest]: [
    ...
    },
    {
      ...
      disabled: false,
      displayDecimal: 2,
      address: addressMap[CHAINS_ID.iotxTest].SEXAddress,
      tag: [],
      deposit: true,
      withdraw: true,
      "futureLongId": 10000000_2, // 这里设置一个很大的数，避免被重复使用
    ...
    },
    {
      ...
      disabled: false,
      displayDecimal: 2,
      address: addressMap[CHAINS_ID.iotxTest].SLPAddress,
      tag: [],
      deposit: true,
      withdraw: true,
      "futureLongId": 10000000_3, // 这里设置一个很大的数，避免被重复使用
    ...
    },
    {
      ...
      displayDecimal: 2,
      tag: [],
      address: addressMap[CHAINS_ID.iotxTest].xHPX,
      "futureLongId": 10000000_6, // 这里设置一个很大的数，避免被重复使用
      "futureShortId": 10000000_6,
      "pars": 0,
      "maxProfitRatio": 1,
